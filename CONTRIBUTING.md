...
Environment variable reference has moved to service-specific READMEs:

- Frontend variables: [`frontend/README.md#environment-variables`](./frontend/README.md#environment-variables)
- Backend variables: [`backend/README.md#environment-variables`](./backend/README.md#environment-variables)

Use the `.env.example` files in each directory as the starting point for local setup.
