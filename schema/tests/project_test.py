...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("leader-email-invalid.yaml", "'leader1' is not a 'email'"),
        ("leader-email-missing-at.yaml", "'leader1.com' is not a 'email'"),
        ("leader-email-invalid-domain.yaml", "'leader1@com' is not a 'email'"),
