...
class TestRepositoryQuery:
        ...
        def test_resolve_repository_existing(self, mock_project, mock_info):
            ...
            with patch("apps.owasp.models.project.Project.objects.get") as mock_get:
                ...
                result = RepositoryQuery.resolve_repository(None, mock_info, project_key="test-project", repository_key="test-repo")
        ...
        def test_resolve_repository_not_found_project(self, mock_info):
            ...
            with patch("apps.owasp.models.project.Project.objects.get") as mock_get:
                ...
                result = RepositoryQuery.resolve_repository(None, mock_info, project_key="non-existent-project", repository_key="test-repo")
        ...
        def test_resolve_repository_not_found_repository(self, mock_project, mock_info):
            ...
            with patch("apps.owasp.models.project.Project.objects.get") as mock_get:
                ...
                result = RepositoryQuery.resolve_repository(None, mock_info, project_key="test-project", repository_key="non-existent-repo")
