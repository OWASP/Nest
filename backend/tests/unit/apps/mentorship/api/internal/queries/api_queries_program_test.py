...
class TestGetProgram:
    ...
    def test_get_program_success(
        ...
        result = asyncio.run(
            api_program_queries.get_program(info=mock_info, program_key="program1")
        )
    ...
    def test_get_program_does_not_exist(
        ...
        result = asyncio.run(
            api_program_queries.get_program(info=mock_info, program_key="nonexistent")
        )
    ...
    def test_get_draft_program_hidden_for_anonymous_user(
        ...
        result = asyncio.run(
            api_program_queries.get_program(info=mock_anonymous_info, program_key="draft-program")
        )
    ...
    def test_get_draft_program_visible_for_admin(
        ...
        result = asyncio.run(
            api_program_queries.get_program(info=mock_info, program_key="draft-program")
        )
