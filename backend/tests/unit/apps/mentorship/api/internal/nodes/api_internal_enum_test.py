...
class TestEnumValues:
    def test_experience_level_enum_values(self):
        ...
        assert (
            ExperienceLevelEnum.BEGINNER.value == ExperienceLevel.ExperienceLevelChoices.BEGINNER
        )
        assert (
        ...
        assert (
            ExperienceLevelEnum.ADVANCED.value == ExperienceLevel.ExperienceLevelChoices.ADVANCED
        )
        assert ExperienceLevelEnum.EXPERT.value == ExperienceLevel.ExperienceLevelChoices.EXPERT

    def test_program_status_enum_values(self):
