...
class TestModuleMutationMenteeDeadline:
    """Tests for mentee-specific deadline permission in set_task_deadline."""
    ...
    @patch("apps.mentorship.api.internal.mutations.module.Module")
    @pytest.mark.asyncio
    async def test_mentee_blocked_when_setting_disabled(self, mock_module):
    ...
    @patch("apps.mentorship.api.internal.mutations.module.timezone")
    @pytest.mark.asyncio
    async def test_mentee_blocked_when_not_assignee(self, mock_tz, mock_module, mock_task):
        """Mentee cannot set deadline for issue they are not assigned to."""
        ...
        ) = AsyncMock(return_value=mock_issue)
    ...
    @patch("apps.mentorship.api.internal.mutations.module.timezone")
    @pytest.mark.asyncio
    async def test_mentee_can_set_deadline_when_assignee(self, mock_tz, mock_module, mock_task):
        ...
        mock_task.objects.aget_or_create = AsyncMock(return_value=(mock_task_instance, True))
