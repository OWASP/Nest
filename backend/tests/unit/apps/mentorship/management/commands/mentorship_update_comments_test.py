...
class TestHandleCommand:
    def test_handle_calls_process_mentorship_modules(self, command):
...
class TestProcessMentorshipModules:
    @patch("apps.mentorship.management.commands.mentorship_update_comments.Module")
    def test_process_mentorship_modules_no_published_modules(self, mock_module, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_update_comments.Module")
    def test_process_mentorship_modules_no_modules_with_labels(self, mock_module, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_update_comments.Module")
    def test_process_mentorship_modules_with_modules(self, mock_module, command):
...
class TestProcessModule:
    ...
    def test_process_module_no_repos(self, mock_get_gh, command, mock_module):
    ...
    def test_process_module(
        ...
        comments_chain = mock_issue.comments.select_related.return_value.filter.return_value
        comments_chain.order_by.return_value = comments_qs
...
class TestProcessIssueInterests:
    ...
    def test_process_issue_interests_new_interest(
        self, mock_issue_user_interest, command, mock_issue, mock_module
    ):
    ...
    def test_process_issue_interests_remove_interest(
        ...
        user1 = make_user(1, "user1")
        comment1 = make_comment(
            body="Not interested anymore", author=user1, created_at="2023-01-01"
        )
    ...
    def test_process_issue_interests_existing_interest_removed(
        ...
        user1 = make_user(1, "user1")
        comment1 = make_comment(
            body="Just a regular comment", author=user1, created_at="2023-01-01"
        )
    ...
    def test_process_issue_interests_multiple_users(
        ...
        comment2_user2 = make_comment(
            body="regular comment", author=user2, created_at="2023-01-02"
        )
