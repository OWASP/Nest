...
from apps.nest.api.internal.mutations.api_key import (
    ApiKeyMutations,
    CreateApiKeyResult,
    RevokeApiKeyResult,
)
...
class TestApiKeyMutations:
    ...
    @patch("apps.nest.api.internal.mutations.api_key.ApiKey.create")
    ...
    @patch("apps.nest.api.internal.mutations.api_key.ApiKey.create", return_value=None)
    ...
    @patch("apps.nest.api.internal.mutations.api_key.ApiKey.create", side_effect=IntegrityError)
    @patch("apps.nest.api.internal.mutations.api_key.logger")
    ...
    @patch("apps.nest.api.internal.mutations.api_key.ApiKey.objects.get")
    ...
    @patch(
        "apps.nest.api.internal.mutations.api_key.ApiKey.objects.get",
