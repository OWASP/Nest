...
class TestLabel:
    ...
    def test_update_data_existing_label(self, mock_get, gh_label):
        ...
        with patch("apps.github.models.label.Label.get_node_id", return_value="test_node_id"):
    ...
    @patch("apps.github.models.label.Label.get_node_id", return_value="test_node_id")
