...
class TestGithubEnrichIssues:
    ...
    def test_handle(
        ...
        mock_issue_class.bulk_save.assert_called_once_with(
            mock_issues, fields=expected_update_fields
        )

    @patch("apps.github.management.commands.github_enrich_issues.OpenAi")
    @patch("apps.github.management.commands.github_enrich_issues.Issue")
    def test_handle_with_offset(self, mock_issue_class, mock_open_ai_class):
    ...
    @patch("apps.github.management.commands.github_enrich_issues.OpenAi")
    @patch("apps.github.management.commands.github_enrich_issues.Issue")
    def test_handle_with_chunked_save(self, mock_issue_class, mock_open_ai_class):
    ...
    @patch("apps.github.management.commands.github_enrich_issues.OpenAi")
    @patch("apps.github.management.commands.github_enrich_issues.Issue")
    def test_handle_no_update_fields(self, mock_issue_class, mock_open_ai_class):
