...
class TestKmsEncryptedField:
    ...
    def test_get_prep_value_with_non_string(self, value):
        ...
        with pytest.raises(TypeError, match=r"Value must be a string to encrypt."):
    ...
    def test_from_db_value_with_invalid_type(self, value):
        ...
        with pytest.raises(TypeError, match=r"Value must be bytes or bytearray to decrypt."):
