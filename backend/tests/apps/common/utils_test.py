...
class TestUtils:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"HTTP_X_FORWARDED_FOR": "172.16.1.100"}, "172.16.1.100"),
            ({"REMOTE_ADDR": "192.168.1.200"}, "192.168.1.200"),
        ],
    )
    ...
    def test_get_user_ip_address_local(self, mocker):
        ...
        mocker.patch.dict(settings._wrapped.__dict__, {"PUBLIC_IP_ADDRESS": "10.0.0.100"})

        assert get_user_ip_address(request) == "10.0.0.100"
