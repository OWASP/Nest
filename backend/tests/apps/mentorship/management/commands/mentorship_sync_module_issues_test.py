...
class TestExtractRepoFullName:
    def test_extract_repo_full_name_from_object(self, command):
        repo = MagicMock()
    ...
    def test_extract_repo_full_name_from_url(self, command, repo_url, expected):
        assert command._extract_repo_full_name(repo_url) == expected


class TestGetStatus:
    def test_get_status_variants(self, command):
        issue = MagicMock()
        issue.state = "closed"
...
class TestGetLastAssignedDate:
    def test_get_last_assigned_date_found_and_not_found_and_exception(self, command):
        mock_repo = MagicMock()
    ...
    def test_get_last_assigned_date_naive_datetime(self, mock_tz, command):
...
class TestBuildRepoLabelToIssueMap:
    def test_build_repo_label_to_issue_map_iterable(self):
        rows = [
            (1, 10, "Label-A"),
            (2, 10, "label-b"),
            (3, 20, "Label-A"),
        ...
        with patch(
            ...
            issue_chain = mock_issue.objects.filter.return_value.values_list.return_value
            issue_chain.iterator.return_value = iter(rows)
            ...
            cmd.stdout.write.assert_any_call(
                "Map built. Found issues for 3 unique repo-label pairs."
            )
...
class TestProcessModule:
    ...
    def test_process_module_links_and_creates_tasks(self, mock_issue, mock_task, command):
        mock_repo = MagicMock()
        mock_repo.id = 77
        ...
        mock_issue_filter_related = (
            mock_issue.objects.filter.return_value.select_related.return_value
        )
    ...
    def test_process_module_no_matches(self):
        mock_repo = MagicMock()
        mock_repo.id = 7
        mock_repo.name = "r"
        mock_module = MagicMock()
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Task")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_process_module_existing_task_with_updates(self, mock_issue, mock_task, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Task")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_process_module_repo_cache_miss_and_failure(self, mock_issue, mock_task, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Task")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_process_module_repo_cache_none(self, mock_issue, mock_task, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Task")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_process_module_assigned_date_none(self, mock_issue, mock_task, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Task")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_process_module_no_repo_full_name(self, mock_issue, mock_task, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Task")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_process_module_issue_no_repository(self, mock_issue, mock_task, command):
        ...
        existing_task = MagicMock(
            module=mock_module, status=Task.Status.IN_PROGRESS, assigned_at=None
        )
        mock_task.objects.get_or_create.return_value = (existing_task, False)
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Task")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_process_module_assignee_none_continues(self, mock_issue, mock_task, command):
...
class TestHandleCommand:
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_handle_full_flow(self, mock_issue, mock_module_cls, mock_get_gh, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Module")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_handle_no_modules(self, mock_issue, mock_module_cls, mock_get_gh, command):
    ...
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Module")
    @patch("apps.mentorship.management.commands.mentorship_sync_module_issues.Issue")
    def test_handle_module_with_zero_links(
        self, mock_issue, mock_module_cls, mock_get_gh, command
    ):
