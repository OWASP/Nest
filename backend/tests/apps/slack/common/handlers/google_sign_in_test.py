...
class TestGoogleSignInHandler:
    ...
    @patch("apps.nest.models.google_account_authorization.GoogleAccountAuthorization.authenticate")
    def test_handle_google_sign_in_when_not_authenticated(self, mock_auth):
        """Test handle_google_sign_in when not authenticated."""
    ...
    @patch("apps.nest.models.google_account_authorization.GoogleAccountAuthorization.authenticate")
    def test_handle_google_sign_in_when_authenticated(self, mock_auth):
        """Test handle_google_sign_in when authenticated."""
