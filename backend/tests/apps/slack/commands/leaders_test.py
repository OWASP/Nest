...
class TestLeadersHandler:
    ...
    def test_handler_with_project_results(
            ...
            "hits": [
                {
                    "idx_key": "test-project",
                    "idx_name": TEST_PROJECT,
                    "idx_leaders": [PROJECT_LEADER_1, "Test Project Leader 2"],
                }
            ]
        }
        ...
        assert PROJECT_LEADER_1 in text
    ...
    def test_handler_with_no_leaders(
        ...
        assert TEST_CHAPTER not in headers_text
        assert TEST_PROJECT not in headers_text
