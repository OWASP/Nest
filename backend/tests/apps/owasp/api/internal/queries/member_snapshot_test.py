...
class TestMemberSnapshotQuery:
    ...
    def test_member_snapshot_by_user_and_year(self):
        ...
        with (
            ...
            mock_snapshot_cls.objects.select_related.return_value = mock_queryset
            ...
            mock_snapshot_cls.objects.select_related.assert_called_once_with("github_user")
            mock_queryset.prefetch_related.assert_called_once_with(
                "issues", "pull_requests", "messages"
            )
            # Two filter calls: one for github_user, one for start_at__year
    ...
    def test_member_snapshots_all(self):
        ...
        with patch(
            ...
            mock_queryset.select_related.assert_called_once_with("github_user")
            mock_queryset.prefetch_related.assert_called_once_with(
                "issues", "pull_requests", "messages"
            )
