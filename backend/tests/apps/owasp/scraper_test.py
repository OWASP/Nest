...
github_repo1 = "https://github.com/repo1"
github_repo2 = "https://github.com/repo2"
...
class TestOwaspScraper:
    ...
    def test_init_success(self, mock_session, mock_fromstring):
        ...
        scraper = OwaspScraper(example_url)

        mock_session.get.assert_called_once_with(example_url, timeout=TIMEOUT)
    ...
    def test_get_urls_with_domain(self):
        ...
        mock_tree = MagicMock()
        mock_tree.xpath.return_value = [github_repo1, github_repo2]
        ...
        assert urls == {github_repo1, github_repo2}

    def test_get_urls_without_domain(self):
        scraper = OwaspScraper.__new__(OwaspScraper)

        mock_tree = MagicMock()
        mock_tree.xpath.return_value = [github_repo1, "https://example.com/other"]
        scraper.page_tree = mock_tree
    ...
    def test_verify_url_success(self, mock_urlparse, mock_session):
        ...
        result = scraper.verify_url(test_url)

        mock_session.get.assert_called_once_with(test_url, allow_redirects=False, timeout=TIMEOUT)
