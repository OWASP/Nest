...
from apps.owasp.management.commands.owasp_aggregate_projects import Command, Project, PullRequest
...
class TestOwaspAggregateProjects:
    ...
    @mock.patch.object(PullRequest, "objects")
    @mock.patch.object(Project, "bulk_save", autospec=True)
    def test_handle(
        self, mock_bulk_save, mock_pr_objects, command, mock_project, offset, projects
    ):
        ...
        assert mock_project.pull_requests.set.called
