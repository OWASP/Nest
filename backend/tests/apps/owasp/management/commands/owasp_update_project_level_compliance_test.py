...
class TestProjectLevelCompliance(SimpleTestCase):
    ...
    def test_parses_official_level_data(
        self, mock_get, mock_metrics, mock_bulk_save
    ):
    ...
    def test_marks_non_compliant_when_levels_differ(
        self, mock_get, mock_metrics, mock_bulk_save
    ):
        mock_get.return_value.status_code = 200
        mock_get.return_value.json.return_value = [
    ...
    def test_remains_compliant_when_levels_match(
        self, mock_get, mock_metrics, mock_bulk_save
    ):
        mock_get.return_value.status_code = 200
        mock_get.return_value.json.return_value = [
