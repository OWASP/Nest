...
class TestExtensionsModule:
    ...
    def test_cache_module_is_accessible(self):
        ...
        try:
            from apps.api.internal.extensions import cache  # noqa: F401, PLC0415
        except ImportError as e:
    ...
    def test_cache_extension_class_is_accessible(self):
        ...
        from apps.api.internal.extensions.cache import CacheExtension  # noqa: PLC0415
    ...
    def test_cache_functions_are_accessible(self):
        ...
        from apps.api.internal.extensions.cache import (  # noqa: PLC0415
            generate_key,
            invalidate_cache,
    ...
    def test_cache_constants_are_accessible(self):
        ...
        from apps.api.internal.extensions.cache import CACHE_MISS  # noqa: PLC0415
