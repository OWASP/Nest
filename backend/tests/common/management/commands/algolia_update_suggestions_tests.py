...
class TestUpdateSuggestionsCommand:
    ...
    def test_client_configuration(self):
        ...
        with patch("apps.common.management.commands.algolia_update_suggestions.settings") as mock_settings:
    ...
    def test_update_config_calls(self):
        ...
        with patch("apps.common.management.commands.algolia_update_suggestions.settings") as mock_settings:
            ...
            for entity in expected_entities:
                ...
                config_call = next(
                    call for call in self.mock_client.update_config.call_args_list
