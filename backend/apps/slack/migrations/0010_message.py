    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thread_timestamp', models.CharField(blank=True, null=True, verbose_name='Thread Timestamp')),
                ('timestamp', models.DateTimeField(blank=True, null=True, verbose_name='Message Timestamp')),
