    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Leave empty for top-level categories. Set to create subcategories (max 3 levels)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='owasp.projectcategory', verbose_name='Parent category')),
            ],
            options={
