    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "age_days",
                    models.PositiveIntegerField(default=0, verbose_name="Project age (days)"),
                ),
                (
                    "contributors_count",
                ...
                (
                    "last_commit_days",
                    models.PositiveIntegerField(default=0, verbose_name="Days since last commit"),
                ),
                (
                    "open_issues_count",
                ...
                (
                    ...
                    models.PositiveIntegerField(default=0, verbose_name="Open PRs"),
                ),
                (
                    "owasp_page_last_update_days",
                    models.PositiveIntegerField(default=0, verbose_name="Days since OWASP update"),
                ),
                (
                    "last_pull_request_days",
                    models.PositiveIntegerField(default=0, verbose_name="Days since last PR"),
                ),
                (
