...
export type CreateBoardCandidateClaimEvidenceMutation = { createBoardCandidateClaimEvidence: { __typename: 'EvidenceResult', ok: boolean, code: string | null, message: string | null, fieldErrors: Array<{ __typename: 'FieldError', field: string, message: string }> | null, evidence: { __typename: 'BoardCandidateClaimEvidenceNode', id: string, createdAt: any, description: string, hasFile: boolean, key: string, name: string, sourceUrl: string, updatedAt: any } | null } };
...
export type RemoveBoardCandidateClaimEvidenceMutation = { removeBoardCandidateClaimEvidence: { __typename: 'EvidenceResult', ok: boolean, code: string | null, message: string | null, fieldErrors: Array<{ __typename: 'FieldError', field: string, message: string }> | null, evidence: { __typename: 'BoardCandidateClaimEvidenceNode', id: string, createdAt: any, description: string, hasFile: boolean, key: string, name: string, sourceUrl: string, updatedAt: any } | null } };
...
export type UpdateBoardCandidateClaimEvidenceMutation = { updateBoardCandidateClaimEvidence: { __typename: 'EvidenceResult', ok: boolean, code: string | null, message: string | null, fieldErrors: Array<{ __typename: 'FieldError', field: string, message: string }> | null, evidence: { __typename: 'BoardCandidateClaimEvidenceNode', id: string, createdAt: any, description: string, hasFile: boolean, key: string, name: string, sourceUrl: string, updatedAt: any } | null } };
