...
export type GetMyCertificateQuery = { myCertificates: Array<{ __typename: 'CertificateNode', id: string, tier: string, issuedAt: any, score: number, isVerified: boolean, githubUser: { __typename: 'UserNode', login: string, name: string, avatarUrl: string } }> };
