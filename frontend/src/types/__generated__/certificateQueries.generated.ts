...
export type GetCertificateQuery = { certificate: { __typename: 'CertificateNode', id: string, issuedAt: any, isVerified: boolean, score: number | null, tier: string, githubUser: { __typename: 'UserNode', avatarUrl: string, login: string, name: string } } | null };

export type GetMyCertificateQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyCertificateQuery = { myCertificates: Array<{ __typename: 'CertificateNode', id: string, issuedAt: any, isVerified: boolean, score: number | null, tier: string, githubUser: { __typename: 'UserNode', avatarUrl: string, login: string, name: string } }> };
