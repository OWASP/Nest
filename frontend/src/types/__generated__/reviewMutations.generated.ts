...
export type CreateBoardCandidateClaimReviewMutation = { createBoardCandidateClaimReview: { __typename: 'ReviewResult', ok: boolean, code: string | null, message: string | null, fieldErrors: Array<{ __typename: 'FieldError', field: string, message: string }> | null, review: { __typename: 'BoardCandidateClaimReviewNode', id: string, createdAt: any, notes: string, status: Types.ReviewStatusEnum } | null } };
