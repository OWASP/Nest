              ...
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div className="lg:col-span-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 text-gray-800 focus:border-[#0D6EFD] focus:outline-none focus-visible:ring-1 focus-visible:ring-[#0D6EFD] dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200"
                  />
                </div>
                ...
                <div className="lg:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    className="w-full resize-none rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 text-gray-800 focus:border-[#0D6EFD] focus:outline-none focus-visible:ring-1 focus-visible:ring-[#0D6EFD] dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200"
                  />
                </div>
              </div>
            </section>
                ...
                {isEdit && (
                  <div className="lg:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 text-gray-800 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200"
                    />
                  </div>
                )}
              </div>
            ...
            <div className="border-t border-gray-200 pt-8 dark:border-gray-700">
              <div className="flex flex-col justify-end gap-4 sm:flex-row">
                <button
                  ...
                  className="rounded-lg border border-gray-300 px-6 py-3 font-medium text-gray-600 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
                >
                  Cancel
                </button>
                <button
