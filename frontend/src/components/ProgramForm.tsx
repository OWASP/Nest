              ...
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div className="lg:col-span-2">
                  ...
                  <input
                    ...
                    required
                    className="focus:outline-hidden w-full rounded-lg border-2 bg-gray-50 px-4 py-3 text-gray-800 dark:bg-gray-800 dark:text-gray-200"
                  />
                </div>
                ...
                <div className="lg:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    className="focus:outline-hidden w-full resize-none rounded-lg border-2 bg-gray-50 px-4 py-3 text-gray-800 dark:bg-gray-800 dark:text-gray-200"
                  />
                </div>
              </div>
            </section>
