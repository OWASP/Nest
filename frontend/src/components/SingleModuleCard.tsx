      ...
      <div className="flex items-center justify-between">
        <div className="flex cursor-pointer items-center gap-2">
          ...
          <Link href={`${pathname}/modules/${module.key}`} className="flex-1">
            <h2 className="max-w-full text-2xl font-semibold break-words text-blue-600 transition-colors duration-300 hover:text-blue-600 sm:break-normal dark:text-blue-300">
              {module.name}
            </h2>
          </Link>
        </div>
