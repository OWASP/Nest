...
const DialogComp: React.FC<ModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} size="4xl" scrollBehavior="inside" onClose={onClose}>
      <ModalContent
        className="animate-scaleIn relative z-50 my-9 w-full transform rounded-lg bg-white p-7 shadow-xl backdrop-blur-xs transition-all duration-300 ease-in-out dark:border dark:border-gray-800 dark:bg-[#212529]"
      ...
      >
        ...
        <ModalFooter className="mt-6 flex justify-end gap-4">
          ...
          <Button
            ...
            className="rounded-md bg-gray-600 px-4 py-1 text-sm font-medium text-white hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-hidden dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-600"
          >
            Close
          </Button>
        </ModalFooter>
