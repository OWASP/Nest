...
const DialogComp: React.FC<ModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} size="4xl" scrollBehavior="inside" onClose={onClose}>
      <ModalContent
        className="animate-scaleIn backdrop-blur-xs relative z-50 my-9 w-full transform rounded-lg bg-white p-7 shadow-xl transition-all duration-300 ease-in-out dark:border-1 dark:border-gray-800 dark:bg-[#212529]"
