          ...
          <div className="flex w-full items-center justify-between">
            ...
            {type === 'module' &&
              ...
              admins?.some(
                ...
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 rounded-md border border-[#0D6EFD] bg-transparent px-2 py-2 text-nowrap text-[#0D6EFD] text-blue-600 transition-all hover:bg-[#0D6EFD] hover:text-white dark:border-sky-600 dark:text-sky-600 dark:hover:bg-sky-100"
                  onClick={() => {
