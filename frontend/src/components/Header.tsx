                ...
                <div className="flex h-full items-center" id="navbar-sticky">
                    <NavLink to="/">
                        <div className="flex h-full items-center">
                            <img src={!dark ? "../public/img/owasp_icon_black_sm.png" : "../public/img/owasp_icon_white_sm.png"} className="h-16 px-2" alt="OWASP Logo"></img>
                            <div className="text-2xl dark:text-slate-300 text-slate-800 dark:hover:text-slate-200">Nest</div>
                        </div>
                    </NavLink>
                    ...
                    <div className="justify-end">
                        <label className="inline-flex items-center content-center cursor-pointer">
                            <span className="ms-3 pr-2 text-sm font-medium text-gray-900 dark:text-gray-300">{icon}</span>
                            <input onChange={toggleTheme} type="checkbox" value="" className="sr-only peer"></input>
                            ...
                            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300"><i className="fa-regular fa-moon"></i></span>
                        </label>
                    </div>
                </div>
            </div>
