const StarRepoButton = () => {
  return (
    <a
      ...
      target="_blank"
      className="group relative hidden h-10 w-full max-w-52 cursor-pointer items-center justify-center gap-1 overflow-hidden whitespace-pre rounded-md border border-b bg-[#87a1bc] px-4 py-2 text-sm font-medium text-black transition-all duration-300 ease-out hover:bg-transparent hover:ring-2 hover:ring-[#87a1bc] hover:ring-offset-2 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 dark:bg-slate-900 dark:text-white dark:hover:bg-slate-900/90 dark:hover:ring-slate-900 md:flex"
    >
      ...
      <div className="flex items-center">
        ...
        <span className="ml-1 text-black dark:text-white">Star on GitHub</span>
      </div>
