    ...
    <div className="flex min-h-[80vh] items-center justify-center">
      <div className="bg-owasp-blue flex w-full max-w-sm flex-col gap-6 rounded-2xl border border-gray-200 p-8 shadow-xl dark:border-slate-700 dark:bg-slate-800">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-black px-4 py-2 font-medium text-white transition-colors hover:bg-gray-900/90 cursor-pointer"
        >
