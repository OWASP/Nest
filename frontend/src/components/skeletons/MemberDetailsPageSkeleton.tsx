...
import { SectionSkeleton } from 'components/skeletons/sharedSkeletons'
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid-cols-2 gap-4 lg:grid">
          {[
            ...
            { keyPrefix: 'milestone', titleWidth: 'w-40' },
        ...
        <div className="grid-cols-2 gap-4 lg:grid">
          {[
            { keyPrefix: 'pr', titleWidth: 'w-48' },
            { keyPrefix: 'release', titleWidth: 'w-48' },
          ].map(({ keyPrefix, titleWidth }) => (
            <SectionSkeleton
              key={keyPrefix}
              titleWidth="w-3/4"
