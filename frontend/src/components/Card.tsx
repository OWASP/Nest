...
const Card = ({
  ...
  return (
    <div className="flex h-fit w-full mt-4 flex-col items-start rounded-md border border-border bg-white py-6 pl-6 pt-0 transition-colors duration-300 ease-linear md:max-w-6xl dark:bg-[#212529]">
