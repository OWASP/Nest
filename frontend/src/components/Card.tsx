...
const Card = ({
  ...
  return (
    <div className="mx-auto mb-2 mt-4 flex w-full max-w-[95%] flex-col items-start rounded-md border-1 border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-[#212529] md:max-w-6xl">
