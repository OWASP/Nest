              ...
              {footerSections.map((section: Section) => (
                <div key={section.title} className="space-y-3 sm:space-y-4">
                  <button
                    ...
                    className="group flex w-full items-center justify-between bg-transparent text-left text-base font-semibold focus:outline-none focus:ring-slate-400 sm:text-lg lg:cursor-default"
