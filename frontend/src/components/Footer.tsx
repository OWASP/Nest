          ...
          {footerSections.map((section: Section) => (
            <div key={section.title} className="flex flex-col gap-4">
              ...
              <Button
                ...
                className="flex w-full items-center justify-start gap-2 rounded-md bg-transparent pl-0 text-left text-lg font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 lg:cursor-default"
