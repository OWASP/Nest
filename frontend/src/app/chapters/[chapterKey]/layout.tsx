...
import { GetChapterMetadataDocument, GetChapterMetadataQuery } from 'types/__generated__/chapterQueries.generated'
import { generateSeoMetadata } from 'utils/metaconfig'
import PageLayout from 'components/PageLayout'

const getChapterMetadata = cache(async (chapterKey: string): Promise<GetChapterMetadataQuery | null> => {
  try {
