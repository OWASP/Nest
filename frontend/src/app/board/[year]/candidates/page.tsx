...
const CandidateCard = ({ candidate, isOwnProfile, year }: CandidateCardProps) => {
  ...
  return (
    <button
      ...
      className="group flex h-full w-full cursor-pointer flex-col items-start justify-start rounded-lg bg-white p-6 text-left shadow-lg transition-shadow duration-300 hover:shadow-xl dark:bg-gray-800 dark:shadow-gray-900/30"
    >
