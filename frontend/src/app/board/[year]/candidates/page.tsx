...
const CandidateCard = ({ candidate, isOwnProfile, year }: CandidateCardProps) => {
  ...
  return (
    <Button
      ...
      className="group flex h-full w-full flex-col items-start justify-start rounded-lg bg-white p-6 text-left shadow-lg transition-shadow duration-300 hover:shadow-xl data-[pressed=true]:scale-100 dark:bg-gray-800 dark:shadow-gray-900/30"
    >
