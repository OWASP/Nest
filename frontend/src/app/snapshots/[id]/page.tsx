...
const SnapshotDetailsPage: React.FC = () => {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-6xl p-4">
      <div className="mt-8 mb-8 rounded-lg border border-gray-200 bg-white p-6 shadow-xs dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            {snapshot.newReleases.map((release, index) => (
              <div
                ...
                className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xs transition-all hover:shadow-md dark:border-gray-700 dark:bg-gray-800"
              >
                <div className="p-4">
