...
const ContributePage = () => {
    ...
    return (
      <React.Fragment key={issue.objectID}>
        <Card
          title={issue.title}
          url={issue.url}
          // Fixed: Handled optional/nullable project details
          projectName={issue.projectName || 'Unknown Project'}
        ...
        <DialogComp
          ...
          title={issue.title}
          // Fixed: Guaranteed string values
          summary={issue.summary || ''}
          hint={issue.hint || ''}
  ...
  return (
    ...
    >
      {/* Fixed: Safe mapping with fallback array check */}
