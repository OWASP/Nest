...
const securityHeaders = [
  {
    ...
    value: [
      "default-src 'self'",
      `script-src 'self' 'unsafe-inline'${isLocal ? " 'unsafe-eval'" : ''} https://owasp-nest.s3.amazonaws.com https://owasp-nest-production.s3.amazonaws.com https://www.googletagmanager.com https://*.i.posthog.com https://*.tile.openstreetmap.org`,
