...
test.describe('Project Details Page', () => {
  ...
  test('should have top contributors', async ({ page }) => {
    ...
    await expect(page.getByRole('img', { name: "Contributor 1's avatar", exact: true })).toBeVisible()
    await expect(page.getByText('Contributor 1', { exact: true })).toBeVisible()
    await expect(page.getByRole('img', { name: "Contributor 2's avatar", exact: true })).toBeVisible()
