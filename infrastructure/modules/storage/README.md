...
| <a name="module_media_bucket"></a> [media\_bucket](#module\_media\_bucket) | ./modules/s3-bucket | n/a |
...
| [aws_iam_policy.media_read_write](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| <a name="output_media_read_write_policy_arn"></a> [media\_read\_write\_policy\_arn](#output\_media\_read\_write\_policy\_arn) | The ARN of the media files read/write IAM policy. |
| <a name="output_media_s3_bucket_name"></a> [media\_s3\_bucket\_name](#output\_media\_s3\_bucket\_name) | The name of the S3 bucket for media files. |
