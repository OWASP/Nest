...
class TerraformTests:
    ...
    def discover_and_run(self, mode: ExecutionMode) -> None:
        ...
        Raises:
            InfrastructureError: If no tests were found or executed for the given mode.
    ...
    def find_test_files(self, test_dir: str, mode: ExecutionMode) -> list[str]:
        ...
        Raises:
            InfrastructureError: If the directory cannot be read.
    ...
    def run_module_tests(self, module_dir: str, test_files: list[str]) -> None:
        ...
        Raises:
            InfrastructureError: If Terraform fails to initialize or if any tests fail.
        ...
        if init_result.returncode != 0:
            raise InfrastructureError(self.failure_message("init", module_dir, init_result))
        ...
        if test_result.returncode != 0:
            raise InfrastructureError(self.failure_message("test", module_dir, test_result))
