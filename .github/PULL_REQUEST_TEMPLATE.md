...
**Exception:** OWASP leaders are not required to follow this rule -- just make sure your username is included in the [exception list](https://github.com/OWASP/Nest/blob/main/.github/check-contribution-skip-usernames.txt).
