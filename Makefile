...
.PHONY: audit-backend-dependencies audit-cspell-dependencies audit-docs-dependencies \
	...
	check-graphql clean clean-tooling-dependencies clean-trivy-cache deploy-on-localstack eslint fix-eslint fix-prettier graphql-codegen help install-frontend-dependencies install-tooling-dependencies load-env-params pre-commit prettier provision-infra prune run \
