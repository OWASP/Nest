...
.PHONY: audit-backend-dependencies audit-cspell-dependencies audit-docs-dependencies \
	...
	check-graphql clean clean-tooling-dependencies clean-trivy-cache eslint fix-eslint fix-prettier graphql-codegen help install-frontend-dependencies install-tooling-dependencies pre-commit prettier prune run run-o11y \
